 ...
 */
public class AdminImgData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AdminImgData</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AdminImgData at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
...
String SAVE_DIR="image";        
        ...
        Part part = request.getPart("file21");
...
// iss m bas run kar
      ...
      String curl= uploadResult.get("url").toString();
